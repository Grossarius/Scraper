...
recipe = st.text_input("Enter the recipe/product:")
...
if recipe:
    ...
    for k, v in all_res.items():
        ...
        st.write("Product: ", k)
        for product in v:
            st.write("Name: ", product['product_name'])
            st.write("Ingredients: ", product['ingredients'])
            st.write("Cup price: ", product['cup_price'])
            st.write("Link: ", product['stockcode'])
            st.write("Price: ", product['price'])
            st.write()  # Empty line for separation between products
    ...
    for item in buy_list:
        ...
        st.write("------------------")
        st.write("Current item: ", item['product_name'])
        st.write("Ingredients: ", item['ingredients'])
        st.write("Link: ", item['stockcode'])
        st.write("Item's price: ", item['price'])
    st.write("------------------")
